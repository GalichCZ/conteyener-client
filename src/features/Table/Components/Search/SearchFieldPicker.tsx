...
const SearchFieldPicker = () => {
  ...
  return (
    <>
      ...
      />
      {drop && (
        <div className="flex flex-col bg-white rounded-md translate-x-[100%] mt-1 shadow-lg w-[150px] cursor-pointer">
          <span
            className={`${searchField === 'other' ? 'bg-orange-200' : ''} rounded-t-md p-1`}
            onClick={() => {
          ...
          <span
            className={`${searchField === 'products' ? 'bg-orange-200' : ''} rounded-b-md p-1`}
            onClick={() => {
