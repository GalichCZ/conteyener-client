...
const Row: FC<Props> = ({ bid }) => {
    ...
    return (
        <TableRow>
            ...
            {roleTypes?.isRoleType7 && <DatesUpdateCell bid={bid} dateLabel={DatesTypesLabelsEnum.DATE_DO}
            ...
            {roleTypes?.isRoleType1 && <DatesUpdateCell bid={bid} dateLabel={DatesTypesLabelsEnum.TRAIN_DEPART_DATE}
                                                        date={bid.train_depart_date}
                                                        dateType={DatesTypesEnum.TRAIN_DEPART_DATE}/>}

            {roleTypes?.isRoleType1 && <DatesUpdateCell bid={bid} dateLabel={DatesTypesLabelsEnum.TRAIN_ARRIVE_DATE}
