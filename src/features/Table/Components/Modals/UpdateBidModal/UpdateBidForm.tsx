        ...
        <FormLayout className="w-full" onFinish={onSubmit}>
            <div className="grid grid-cols-5 gap-x-10 gap-y-3">
                ...
                <GInputs.Array setValue={setValue}
                               ...
                               name="inside_number"
                               label={columns.INSIDE_NUMBER} control={control}/>
                ...
                <GInputs.Array setValue={setValue}
                               ...
                               name="proform_number"
                               label={columns.PROFORM_NUMBER} control={control}/>
                ...
                <GInputs.Text placeholder={columns.CONTAINER_NUMBER.toString()} name="container_number"
                              label={columns.CONTAINER_NUMBER} control={control}/>
                ...
                <GInputs.Select isLoading={isLoadingStores} values={preparedStores}
                                tooltips={[]}
                ...
                <GInputs.Text placeholder={columns.LINE} name="line"
                              label={columns.LINE} control={control}/>
                ...
                <GInputs.Text placeholder={columns.PORT} name="port"
                              label={columns.PORT} control={control}/>

                <GInputs.Switch name="is_ds" label={columns.IS_DS} control={control}/>

                <GInputs.Text placeholder={columns.FRAHT_ACCOUNT} name="fraht_account"
                              label={columns.FRAHT_ACCOUNT} control={control}/>
                ...
                <GInputs.Date placeholder={columns.ANSWER_OF_OB} name="answer_of_ob"
                              label={columns.ANSWER_OF_OB} control={control}/>

                <GInputs.Text placeholder={columns.EXPEDITOR} name="expeditor"
                              label={columns.EXPEDITOR} control={control}/>

                <GInputs.Text placeholder={columns.DESTINATION_STATION} name="destination_station"
                              label={columns.DESTINATION_STATION} control={control}/>

                <GInputs.Select isLoading={isLoadingStock} values={preparedStockPlaces} tooltips={[]}
                                placeholder={columns.STOCK_PLACE} name="stock_place"
                                label={columns.STOCK_PLACE}
                                control={control}/>

                <GInputs.Text placeholder={columns.PICKUP} name="pickup"
