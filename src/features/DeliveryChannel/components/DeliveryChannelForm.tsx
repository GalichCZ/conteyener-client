        ...
        <FormLayout className="shadow-none" onFinish={onSubmit}>
            ...
            <div className="grid grid-cols-3">
                ...
                <GInputs.Number min={0} max={1000} name={names.DECLARATION_ISSUE_DATE}
                                ...
                                control={control}/>
                <GInputs.Number min={0} max={1000} name={names.TRAIN_DEPART_DATE}
                                label={labels.TRAIN_DEPART_DATE}
                                control={control}/>
                <GInputs.Number min={0} max={1000} name={names.TRAIN_ARRIVE_DATE}
                                label={labels.TRAIN_ARRIVE_DATE}
                                control={control}/>
                <GInputs.Number min={0} max={1000} name={names.STORE_ARRIVE_DATE}
