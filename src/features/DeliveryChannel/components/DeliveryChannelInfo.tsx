...
const DeliveryChannelInfo: FC<Props> = ({ deliveryChannel }) => {
  ...
  return (
    <>
      ...
      <Tooltip id="delete" />
      <RowWrap>
        <PoleWrap>{deliveryChannel.name}</PoleWrap>
        <PoleWrap>{deliveryChannel.eta}</PoleWrap>
        <PoleWrap>{deliveryChannel.date_do}</PoleWrap>
        <PoleWrap>{deliveryChannel.declaration_issue_date}</PoleWrap>
        <PoleWrap>{deliveryChannel.train_depart_date}</PoleWrap>
        <PoleWrap>{deliveryChannel.train_arrive_date}</PoleWrap>
        <PoleWrap>{deliveryChannel.store_arrive_date}</PoleWrap>
        <PoleWrap>
          <Button
